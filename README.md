# DECO_DCGAN
Construct a DCGAN in TFLearn and use data augmentation to test if the generative model can learn to produce images with rotation-invariant features. The code used here is a modified version of the standard TFLearn DCGAN implimentation ([Link](http://tflearn.org/examples/)).
